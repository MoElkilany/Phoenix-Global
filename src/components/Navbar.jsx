      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex items-center justify-between">
          <a href="#hero" className="flex items-center gap-3 flex-shrink-0">
            ...
            <div>
              <span className="text-xl font-bold tracking-widest block" style={{ color: '#D4AF37', fontFamily: 'Cinzel, serif' }}>
                PHOENIX
              </span>
              <span className="text-[10px] tracking-wider block -mt-1" style={{ color: 'rgba(250,250,249,0.5)', fontFamily: 'Cairo, sans-serif' }}>
                GLOBAL
              </span>
            </div>
          </a>
          ...
          <div className="hidden lg:flex items-center gap-1">
            {navLinks.map((link, index) => (
              <a
                ...
                style={{ color: 'rgba(250, 250, 249, 0.7)', fontFamily: 'Cairo, sans-serif' }}
              >
          ...
          <div className="flex flex-col gap-1">
            {navLinks.map((link, index) => (
              <a
                ...
                style={{ color: 'rgba(250, 250, 249, 0.85)', fontFamily: 'Cairo, sans-serif' }}
